...
//#include <PinChangeInterrupt.h>   All Teensy Digital pins have interrupt
...
//#define BATTERY_SENSE_PIN 23 // not implemented
...
void Setup_MPU6050_DMP()
{
   ...
   if(devStatus == 0){
    ...
    attachInterrupt(digitalPinToInterrupt(PUSH2), dmpDataReady, RISING);
